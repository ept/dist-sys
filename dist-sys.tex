...
\end{frame}
\inlineslide{s:dist-sys-definition}{\href{https://www.youtube.com/watch?v=UEAMfLPZZhE&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=1}{Start of video section 1.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/09.1_Distributed_systems_introduction.mp4}{mp4 download})}\label{l:dist-sys-definition}
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:networking}{\href{https://www.youtube.com/watch?v=1F3DEq8ML1U&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=2}{Start of video section 1.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/09.2_Computer_networking.mp4}{mp4 download})}
...
\begin{frame}
    ...
    \end{center}
\end{frame}
\inlineslide{s:payment-example}{\href{https://www.youtube.com/watch?v=S2osKiqQG9s&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=3}{Start of video section 1.3}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/09.3_Remote_Procedure_Call.mp4}{mp4 download})}
...
\begin{frame}
    ...
    \end{center}
\end{frame}
\inlineslide{s:two-generals}{\href{https://www.youtube.com/watch?v=MDuWnzVnfpI&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=4}{Start of video section 2.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/10.1_Two_generals_problem.mp4}{mp4 download})}\label{l:two-generals}
...
\begin{frame}
    ...
    \end{center}
\end{frame}
\inlineslide{s:byzantine-generals}{\href{https://www.youtube.com/watch?v=LoGx_ldRBU0&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=5}{Start of video section 2.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/10.2_Byzantine_generals_problem.mp4}{mp4 download})}\label{l:byzantine-generals}
...
\end{frame}
\inlineslide{s:system-model}{\href{https://www.youtube.com/watch?v=y8f7ZG_UnGI&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=6}{Start of video section 2.3}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/10.3_System_models.mp4}{mp4 download})}\label{l:system-model}
...
% TODO explain that synchronous/asynchronous are also used e.g. in the context of RPC, in which case "synchronous" means "caller thread waits until response is received", and "asynchronous" means "caller thread continues doing other stuff (potentially making further RPC requests) while RPC is in progress"
...
\end{frame}
\inlineslide{s:availability}{\href{https://www.youtube.com/watch?v=43TDfUNsM3E&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=7}{Start of video section 2.4}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/10.4_Fault_tolerance.mp4}{mp4 download})}\label{l:availability}
...
\begin{frame}
    ...
    What happened?
\end{frame}
\inlineslide{s:mystery}{\href{https://www.youtube.com/watch?v=FQ_2N3AQu0M&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=8}{Start of video section 3.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/11.1_Physical_time.mp4}{mp4 download})}\label{l:mystery}
...
\end{frame}
\inlineslide{s:clock-sync}{\href{https://www.youtube.com/watch?v=mAyW-4LeXZo&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=9}{Start of video section 3.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/11.2_Clock_synchronisation.mp4}{mp4 download})}\label{l:clock-sync}
...
\end{frame}
\inlineslide{s:moon-cheese}{\href{https://www.youtube.com/watch?v=OKHIdpOAxto&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=10}{Start of video section 3.3}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/11.3_Causality_and_happens-before.mp4}{mp4 download})}\label{l:moon-cheese}
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:logical-clocks}{\href{https://www.youtube.com/watch?v=x-D8iFU1d-o&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=11}{Start of video section 4.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/12.1_Logical_time.mp4}{mp4 download})}\label{l:logical-clocks}
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:broadcast-intro}{\href{https://www.youtube.com/watch?v=A8oamrHf_cQ&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=12}{Start of video section 4.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/12.2_Broadcast_delivery_order.mp4}{mp4 download})}\label{l:broadcast-intro}
...
\begin{frame}
    ...
    \end{center}%
\end{frame}
\inlineslide{s:broadcast-alg}{\href{https://www.youtube.com/watch?v=77qpCahU3fo&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=13}{Start of video section 4.3}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/12.3_Broadcast_algorithms.mp4}{mp4 download})}\label{l:broadcast-alg}
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:replication-intro}{\href{https://www.youtube.com/watch?v=mBUCF1WGI_I&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=14}{Start of video section 5.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/13.1_Replication.mp4}{mp4 download})}\label{l:replication-intro}
...
\begin{frame}
    ...
    \end{tabular}
\end{frame}
\inlineslide{s:fault-probability}{\href{https://www.youtube.com/watch?v=uNxl3BFcKSA&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=15}{Start of video section 5.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/13.2_Quorums.mp4}{mp4 download})}\label{l:fault-probability}
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:smr}{\href{https://www.youtube.com/watch?v=mlWOQuO55PE&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=16}{Start of video section 5.3}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/13.3_State_machine_replication.mp4}{mp4 download})}\label{l:smr}
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:failover}{\href{https://www.youtube.com/watch?v=rN6ma561tak&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=17}{Start of video section 6.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/14.1_Consensus.mp4}{mp4 download})}\label{l:failover}
...
% Make clearer that safety depends only on an asynchronous system model, and only liveness requires partial synchrony.
...
When a node suspects the leader to have failed, it transitions to the candidate state, increments the term number, and starts a leader election in that term.
...
\begin{frame}
    ...
    \end{center}%
\end{frame}
\inlineslide{s:raft-states}{\href{https://www.youtube.com/watch?v=IPnesACYRck&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=18}{Start of video section 6.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/14.2_Raft.mp4}{mp4 download})}\label{l:raft-states}
...
% TODO: it might be nicer to write CommitLogEntries like this:
%
% while commitLength < log.length {
%   acks := 0
%   for each node in nodes {
%     if ackedLength[node] > commitLength {
%       acks := acks + 1
%     }
%   }
%   if acks >= ceil((|nodes| + 1) / 2) {
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:consistency}{\href{https://www.youtube.com/watch?v=-_rdWB9hN1c&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=19}{Start of video section 7.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/15.1_Two-phase_commit.mp4}{mp4 download})}\label{l:consistency}
...
\end{frame}
\inlineslide{s:linearizability}{\href{https://www.youtube.com/watch?v=noUNH3jDLC0&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=20}{Start of video section 7.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/15.2_Linearizability.mp4}{mp4 download})}\label{l:linearizability}
...
\begin{frame}
    ...
    \frametitle{Making quorum reads/writes linearizable}
    \begin{tikzpicture}
        \node [rectangle,fill=red!10,draw] (node1) at (0,5.9) {client 1};
        \node [rectangle,fill=red!10,draw] (node2) at (2,5.9) {\storageSymbol}; \node [yshift=-0.2cm] at (node2) {$A$};
        \node [rectangle,fill=red!10,draw] (node3) at (4,5.9) {\storageSymbol}; \node [yshift=-0.2cm] at (node3) {$B$};
...
% TODO exercise: write pseudocode for the ABD algorithm.
...
\end{frame}
\inlineslide{s:eventual-1}{\href{https://www.youtube.com/watch?v=9uCP3qHNbWw&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=21}{Start of video section 7.3}\\(\href{https://www.cl.cam.ac.uk/teaching/2021/ConcDisSys/video/15.3_Eventual_consistency.mp4}{mp4 download})}\label{l:eventual-1}
...
However, such software would be slow to use, since every read or write operation would have to contact a quorum of replicas; moreover, it would not work offline.
...
A CRDT is a replicated object that an application accesses though the object-oriented interface of an abstract datatype, such as a set, list, map, tree, counter, etc.

\autoref{l:op-crdt-map} and \autoref{l:delete-crdt-map} show an example of a CRDT that provides a map from keys to values.
The application can invoke three types of operation: reading the value for a given key, updating the value for a given key, and deleting a key from the map.
...
\begin{frame}
    ...
    \begin{algorithmic}
        ...
        \On{request to set key $k$ to value $v$}
            ...
            \State \textbf{broadcast} $(\mathsf{set}, t, k, v)$ by causal broadcast (including to self)
        \EndOn
        \State
        \On{delivering $(\mathsf{set},t,k,v)$ by causal broadcast}
...
\begin{frame}
    \label{s:delete-crdt-map}
    \frametitle{Deletion in operation-based map CRDT}
    \begingroup\footnotesize
    \begin{algorithmic}
        \On{request to delete key $k$}
            \If{$\exists t,v.\; (t,k,v) \in \mathit{values}$}
                \State \textbf{broadcast} $(\mathsf{delete}, t)$ by causal broadcast (including to self)
            \EndIf
        \EndOn
        \State
        \On{delivering $(\mathsf{delete},t)$ by causal broadcast}
    ...
    \endgroup\pause
    \begin{itemize}
        \item Reliability of causal broadcast ensures every operation is eventually delivered to every (non-crashed) replica\pause
        \item Applying an operation is \textbf{commutative}: all causal delivery orders converge to the same state\pause
        \item Therefore, get \textbf{strong eventual consistency}
    \end{itemize}
\end{frame}
\inlineslide{s:delete-crdt-map}{}\label{l:delete-crdt-map}

To update the value for a given key, we create a globally unique timestamp for the operation~-- a Lamport timestamp (\autoref{l:lamport-definition}) is a good choice~-- and then causally broadcast a message containing the timestamp, key, and value.
...
For deletions, we find the timestamp of the last update to the key (if any), and causally broadcast that timestamp in a $\mathsf{delete}$ message.
On delivering that message, a node checks its local $\mathit{values}$ and removes any element with that timestamp.
There is no need to include the key in the message because the timestamp already uniquely identifies the update, and therefore the key being deleted.

This algorithm is an example of an approach that we hinted at on \autoref{l:causal-replication}, namely, a method for performing replication using causal broadcast.
It is an \emph{operation-based} CRDT because each broadcast message contains a description of an operation (as opposed to \emph{state-based} CRDTs that we will see shortly).
It allows operations to complete without network connectivity, because the sender of a causal broadcast can immediately deliver a message to itself, and send it to other nodes sometime later.
Moreover, even though concurrently broadcast messages may be delivered in different orders on different replicas, the algorithm ensures strong eventual consistency because the functions that update a replica's state are commutative.

\supervision{
    Prove that the operation-based map CRDT algorithm provides strong eventual consistency.
}{
    The \emph{eventual delivery} property of strong eventual consistency holds because causal broadcast is reliable: any message delivered by one non-faulty node will also be delivered by all other non-faulty nodes.
    ...
    Note that the replica state $\mathit{values}$ is determined entirely and deterministically by the sequence of messages delivered by causal broadcast.
    Consider two replicas, $A$ and $B$, on which causal broadcast has delivered the same set of messages; that is, their sequences of deliveries contain the same messages, and $A$'s sequence of deliveries is a permutation of $B$'s sequence of deliveries.
    ...
    Causal broadcast ensures that if there is a causal dependency between messages, then all nodes deliver those messages in the same order; only concurrent messages may be delivered in a different order at each node.
    Thus, we can transform $A$'s sequence of deliveries into $B$'s sequence of deliveries by repeatedly performing pairwise swaps of two adjacent messages in the sequence.
    Moreover, the two messages being swapped each time are always messages that were broadcast concurrently, so every delivery order produced by such swaps is a valid causal order.
    ...
    We prove commutativity case by case depending on the type of message:
    \begin{enumerate}
        \item Let $a = (\mathsf{set}, t_a, k_a, v_a)$ and $b = (\mathsf{set}, t_b, k_b, v_b)$.
            We have $t_a \ne t_b$ due to the assumption of globally unique timestamps and because causal broadcast does not duplicate messages.
        ...
        \item Let $a = (\mathsf{set}, t_a, k_a, v_a)$ and $b = (\mathsf{delete}, t_b)$.
            Note that when a $\mathsf{delete}$ message is broadcast, it always contains the timestamp of an existing tuple in $\mathit{values}$, which must have been placed there by processing an earlier $\mathsf{set}$ operation with that timestamp $t_b$.
            Let $c = (\mathsf{set}, t_b, \dots)$ be that earlier message.

            $c$ must have already been delivered before $b$ was broadcast, but we are assuming that $a$ and $b$ are concurrent, so therefore $c \ne a$.
            Moreover, since each $\mathsf{set}$ message contains a unique timestamp, we have $t_a \ne t_b$.
            ...
            \begin{enumerate}
                \item $\nexists t,v.\; (t,k_a,v) \in \mathit{values}.$
                    ...
                    A replica that first processes $a$ will first be in state $\mathit{values} \cup \{(t_a,k_a,v_a)\}$.
                    After processing $b$, the tuple containing timestamp $t_b$ (if any) is removed from the set.

                    A replica that first processes $b$ first removes the tuple containing timestamp $t_b$ from the set, then adds $(t_a,k_a,v_a)$ to the set.
                    Since $t_a \ne t_b$, the tuple removed by processing $b$ is not the tuple added by processing $a$, so both orders of processing have the same outcome.

                \item There exist $t,v$ such that $(t,k_a,v) \in \mathit{values}$.
                    By uniqueness of timestamps, $t \ne t_a$, but it is possible that $t = t_b$.
                    Once again we consider cases:
                    \begin{enumerate}
                        \item $t < t_a$.

                            A replica that first processes $a$ will first be in state $\mathit{values} \setminus \{(t,k_a,v)\} \cup \{(t_a,k_a,v_a)\}$.
                            After processing $b$, the tuple containing timestamp $t_b$ (if any) is removed from the set.

                            A replica that first processes $b$ first removes the tuple containing $t_b$ from the set, then adds $\{(t_a,k_a,v_a)\}$ to the set.
                            Since $t \ne t_a$, the tuple removed by processing $b$ is not the tuple added by processing $a$, so both orders of processing have the same outcome.
                        \item $t_a < t$.

                            A replica that first processes $a$ will leave the state unchanged.
                            After processing $b$, the tuple containing timestamp $t_b$ (if any) is removed from the set.

                            A replica that first processes $b$ first removes the tuple containing $t_b$ from the set.
                            If $t \ne t_b$ then processing $a$ has no effect as before.
                            However, if $t = t_b$, then processing $a$ next adds $\{(t_a,k_a,v_a)\}$ to the set.
                            \textbf{BUG: this case does not commute!}
                    \end{enumerate}
            \end{enumerate}

        \item Let $a = (\mathsf{delete}, t_a)$ and $b = (\mathsf{set}, t_b, k_b, v_b)$.
            This case is the same as the previous case.
        \item Let $a = (\mathsf{delete}, t_a)$ and $b = (\mathsf{delete}, t_b)$.
            TODO.
    \end{enumerate}
}
...
% Excercise: prove that in op-based LWW map CRDT, ops are commutative. Support both deletion and assignment
% Excercise: make a variant of the algorithm that has multi-value semantics rather than LWW
% TODO: demo video of two Google Docs windows side-by-side
% Operational Transformation
% Text CRDT using rational numbers
...
\end{frame}
\inlineslide{s:spanner-intro}{}\label{l:spanner-intro}

Spanner \citep{Corbett:2012}
...
Spanner's implementation of snapshot isolation uses \emph{multi-version concurrency control} (MVCC), a particular form of optimistic concurrency control similar to what was discussed in the first half of this course.
MVCC is based on assigning a timestamp to every transaction; when a transaction 
...
The MVCC algorithm of comparing transaction timestamps requires that if transaction $T_1$ happened before transaction $T_2$, then the timestamp of $T_1$ must be less than that of $T_2$.
...
\begin{frame}
    ...
    \uncover<2->{Spanner's TrueTime clock returns $(\mathit{earliest}, \mathit{latest})$.}\\%
...
When transaction $T_i$ wants to commit, it gets a timestamp interval $[t_{i,\mathsf{earliest}}, t_{i,\mathsf{latest}}]$ from TrueTime, and assigns $t_{i,\mathsf{latest}}$ to be the commit timestamp of $T_i$.
...
Google assumes a node's quartz clock has a maximum drift rate of 200~ppm.
