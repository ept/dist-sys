...
Using TrueTime thus allows Spanner to assign transaction commit timestamps that are consistent with causality and real-time order, while keeping transactions fast, and without placing any requirement on clients to propagate logical timestamps.
