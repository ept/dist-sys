...
\begin{frame}
    \begin{center}
        Lecture 2\\[2em]
        \Large{\color{tumblue}{Models of distributed systems}}
    \end{center}
\end{frame}
...
\begin{frame}
    \begin{center}
        Lecture 3\\[2em]
        \Large{\color{tumblue}{Time, clocks, and ordering of events}}
    \end{center}
\end{frame}
...
\begin{frame}
    \begin{center}
        Lecture 4\\[2em]
        \Large{\color{tumblue}{Broadcast protocols and logical time}}
    \end{center}
\end{frame}
...
\begin{frame}
    \begin{center}
        Lecture 5\\[2em]
        \Large{\color{tumblue}{Replication}}
    \end{center}
\end{frame}
...
\begin{frame}
    \begin{center}
        Lecture 7\\[2em]
        \Large{\color{tumblue}{Replica consistency}}
    \end{center}
\end{frame}
...
\begin{frame}
    \begin{center}
        Lecture 8\\[2em]
        \Large{\color{tumblue}{Case studies}}
    \end{center}
\end{frame}
