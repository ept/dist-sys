...
Ideally, we would like a timeout to occur only if the node really has crashed (this is called a \emph{perfect failure detector}).
...
Thus, in an asynchronous or partially synchronous system, a perfect failure detector does not exist, and the best we can hope for is an \emph{eventually perfect failure detector} \citep{Chandra:1996}.
