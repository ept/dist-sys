...
A typical solution is to use an \emph{Interface Definition Language} (IDL) to provide a language-independent type signatures of the functions that are being made available over RPC.
...
The details of this language are not important for this course.
