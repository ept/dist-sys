% Lecturing at TUM in Nov 2022: have a 2.5 hour time slot, of which about 2 hours are used for lecture, and the rest is break.
% Week 1: got up to \autoref{l:model-summary}
% Week 2: got up to \autoref{l:causal-broadcast}
% Week 3: got up to \autoref{l:consistency}
% Week 4: Consensus/Raft and atomic commit (but skipped section on linearizability)
...
% TODO: latest version of Protobuf doesn't have required fields any more
\begin{frame}
    \label{s:rpc-idl}
...
% TODO: not sure if TUM students have encountered "strict total order" before.
...
If you have studied databases you will know that a key property of a transaction is \emph{atomicity}.
...
\begin{frame}
    \label{s:advertisement}
    \frametitle{Advertisement}
    I am taking on research students (master + PhD) for projects in the following areas:
    \begin{itemize}
        \item implementing local-first collaboration software
        \item CRDTs (theory, new algorithms, performance, practical implementations)
        \item security protocols, encryption, privacy for collaboration
        \item Byzantine fault tolerant CRDTs
        \item formal verification (e.g.\ using Isabelle/HOL) of the above\\[1em]
    \end{itemize}
    Please get in touch if you're interested:\\
    \url{martin.kleppmann@in.tum.de}
\end{frame}
\inlineslide{s:advertisement}{}\label{l:advertisement}
