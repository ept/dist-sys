...
In a URL, the part between the \verb|//| and the following \verb|/| is the hostname of the server to which the client is going to send the request (e.g.\ \texttt{www.cit.tum.de}), and the rest (e.g.\ \texttt{/en/cit/home/}) is the path that the client asks for in its request message.
