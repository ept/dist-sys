...
In this setting, the Byzantine generals problem is to ensure that all honest generals agree on the same plan (e.g.\ whether to attack or to retreat).
...
The Byzantine generals problem is about faulty nodes, while the two generals problem is about faulty networks.
Unfortunately, in real systems, both nodes and networks might be faulty!
